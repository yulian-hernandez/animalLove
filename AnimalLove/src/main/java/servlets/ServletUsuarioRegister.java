...
public class ServletUsuarioRegister extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String id_usuario = request.getParameter("username");
        ...
        String result = usuario.form_registro(id_usuario, contrasenia, tipo_documento, nombre, apellido, telefono, email, departamento, ciudad);
